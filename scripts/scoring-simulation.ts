...
expect("no-ball + 4 boundary total = 5", totalRunsForBall(shape({ extra_type: "no_ball", runs_off_bat: 4, extra_runs: 1 }) as any), 5);
expect("no-ball + 2 byes total = 3", totalRunsForBall(shape({ extra_type: "no_ball", runs_off_bat: 0, extra_runs: 3 }) as any), 3);
