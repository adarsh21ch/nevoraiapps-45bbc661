        ...
        <Popover open={langOpen} onOpenChange={setLangOpen}>
          <PopoverTrigger asChild>
            <button type="button" className={rowClass}>
              <RowLeft icon={Languages} label="'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                            \n                                            Just make sure that attendance is working because I think coach is complaining something that that is not working kind of thing. So make sure the students, uh, are able to scan and, uh, do attendance, right? Everything should work correctly." />
