        ...
        <Popover open={langOpen} onOpenChange={setLangOpen}>
          <PopoverTrigger asChild>
            <button type="button" className={rowClass}>
              <RowLeft icon={Languages} label="'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                            \n                                            There is one more thing we need to update, one more logic because for example, if some students coming morning also or coming in evening also, like both sessions, right? So for example, they come in morning, they check in, they go, they check out. So when they come in evening, so again, they check in and check out, right? The system also should work because it is not something only one time check in, check out. If some student coming both the time, morning and evening both. So both the time they do check in and check out and check in and check out. So our system should be handle and capable of that logic also. Both the time record should be calculated or they can able to do. And also we calculate that timing also or student have also that particular data of it. If it is coming in both sessions, so on morning and evening check in, check out. And day wise also. So how you can manage it perfectly, it's your way of doing it, but I want this particular thing also should work correctly. So user should not feel like something is missing or owner of the academy should feel like it is not working around." />
