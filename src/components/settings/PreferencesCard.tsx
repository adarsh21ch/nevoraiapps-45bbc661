        ...
        <Popover open={langOpen} onOpenChange={setLangOpen}>
          <PopoverTrigger asChild>
            <button type="button" className={rowClass}>
              <RowLeft icon={Languages} label="'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                            \n                                            I mean this add and invite pillar. I guess the magic link we had, we have developed that rest of the information which is required for a student need to fill that he can fill with using that particular link and sign in. So it will not duplicate the same student. Because the owner of the academy will still create his name and session and all. Automatically that particular magic link, his name is already there and their batch is already selected. Which session they are enrolled. So the fees and all should not match. This match, right?" />
