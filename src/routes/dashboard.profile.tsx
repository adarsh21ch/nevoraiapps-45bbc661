...
function ProfilePage() {
  ...
  sections.push({
    ...
    rows: [
      ...
      {
        to: "/dashboard/settings",
        label: "Also, one more thing. There is a issue, not issue, like notification kind of thing, that users are not click or checkbox determine condition thing. So it not submitting. So please make sure that if user do not, uh, click on that, he click on submit kind of thing, we show a notification thing. Please, uh, check mark, or we highlight it in a red color. So please check the particular box. So at least user will know this, like, I have to check this thing, that's why. Got it? Otherwise, they're messaging me, \"I'm not able to register.\" So we have-- When he not click and he click on register kind of thing, uh, button, if it not checkbox, we can show that please check this particular thing. We may mark it in red color. We make the fonts in red color, so they will understand, okay, need to check this particular thing, right? So they can check and continue.",
