...
function ProfilePage() {
  ...
  sections.push({
    ...
    rows: [
      ...
      {
        to: "/dashboard/settings",
        label: "Also, please update the KPI. Still it is collect-collected this month shows 3,700. Pending fees is showing 19,200. But when I open the fees tab, the pending is showing 13,200. That is correct. We have a ten student pending. So, uh, please update the, uh, KPIs or the logic and make the previous all the things zero, right? Remove that particular data, delete it, right? We continue from here like a fresh, so at least we have a correct number showing. So collected this month shows, uh, zero because the paid is zero for this month. And pending, which it shows in the 13,200, it shows in the KPI pending amount, right? We, we have to fix this logic or, uh, finance thing. Now, we cannot, uh, fuck on this particular thing, right? Please, uh, make the logic go through database how we correct this thing and make sure the data and numbers should be correct, right? And then we continue to maintain the finance properly there historically and all. Right?",
