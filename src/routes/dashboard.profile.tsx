...
function ProfilePage() {
  ...
  sections.push({
    ...
    rows: [
      ...
      {
        to: "/dashboard/settings",
        label: "Okay, there is a lot of improvement or improvisation we need to do. First thing is that the coaching is, uh, what to say? For example, in this particular coaching, he d- he has this particular system that boys, student have different fees and girls student have different fees, right? So what to do now? Uh, because maybe some academies don't have this thing, so we cannot make it universal logic, this. So what we can do, on a fees section, uh, we should have to edit one option there, right? That, girls fees kind of thing, like different fees for the girls kind of thing, right? So boys have different, girls has different. So h- if he-- if it enable the fees section that, girls have the, well, girls fees... I don't know how we use the terminologies, because by default we have, five, batches and their fees, right? Girls have different. So for the girls, he check mark or enable it for the girls, and same five batches should be shown in the girls also. But I can edit the fees of the girls, right? According to. So whenever somebody do registration or select their gender as girls, so automatically it updated the fees of the particular batch according to girls gender, right? One thing.",
