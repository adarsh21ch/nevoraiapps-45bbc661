    ...
    items: [
      {
        to: "/dashboard/fees",
        label: "Fees",
        hint: "Invoices, collections & receipts",
        icon: IndianRupee,
        requiresFeature: "fee_tracking",
        keywords: ["invoices", "collections", "dues", "pending"],
      },
      {
        to: "/dashboard/fee-plans",
        label: "Fee Plans",
        hint: "Pricing plans & auto-billing rules",
        icon: IndianRupee,
        requiresFeature: "fee_tracking",
        keywords: ["pricing", "plans", "auto-bill"],
      },
      {
        to: "/dashboard/payment-verification",
        label: "Payment Verification",
        hint: "Approve manual & offline payments",
        icon: ReceiptText,
        requiresFeature: "fee_tracking",
        keywords: ["manual", "offline", "cash", "approve", "verify", "utr"],
      },
      {
        to: "/dashboard/reminders",
        label: "Fee Reminders",
        hint: "Scheduled reminders & delivery history",
        icon: CalendarClock,
        requiresFeature: "fee_tracking",
        keywords: ["reminders", "overdue", "notifications"],
      },
    ],
  },
  {
